...
module mac_fsm (
  ...
  begin : main_fsm_comb
    ...
    // a stream
    ctrl_streamer_o.a_source_ctrl.addressgen_ctrl.trans_size  = ctrl_i.len/2;
    ctrl_streamer_o.a_source_ctrl.addressgen_ctrl.line_stride =reg_file_i.hwpe_params[MAC_REG_STRIDE];//'0;
    ctrl_streamer_o.a_source_ctrl.addressgen_ctrl.line_length = 1;//ctrl_i.len/2;
    ctrl_streamer_o.a_source_ctrl.addressgen_ctrl.feat_stride ='0;
    ctrl_streamer_o.a_source_ctrl.addressgen_ctrl.feat_length =8;//1;  
    ...
    // b stream
    ctrl_streamer_o.b_source_ctrl.addressgen_ctrl.trans_size  = ctrl_i.len/2;
    ctrl_streamer_o.b_source_ctrl.addressgen_ctrl.line_stride =reg_file_i.hwpe_params[MAC_REG_STRIDE];//'0;
    ctrl_streamer_o.b_source_ctrl.addressgen_ctrl.line_length =1; //ctrl_i.len/2;
    ctrl_streamer_o.b_source_ctrl.addressgen_ctrl.feat_stride = '0;
    ctrl_streamer_o.b_source_ctrl.addressgen_ctrl.feat_length =8; //1;
    ...
    // c stream
    ctrl_streamer_o.c_source_ctrl.addressgen_ctrl.trans_size  = (ctrl_i.shift==2)? ctrl_i.len/2 : '0;
    ctrl_streamer_o.c_source_ctrl.addressgen_ctrl.line_stride = '0;
    ctrl_streamer_o.c_source_ctrl.addressgen_ctrl.line_length =(ctrl_i.shift==2)? ctrl_i.len/2 : '0;
    ctrl_streamer_o.c_source_ctrl.addressgen_ctrl.feat_stride = '0;
    ctrl_streamer_o.c_source_ctrl.addressgen_ctrl.feat_length = 1;                                            //
    ctrl_streamer_o.c_source_ctrl.addressgen_ctrl.base_addr   = reg_file_i.hwpe_params[MAC_REG_C_ADDR] +8*(flags_uloop_i.offs[MAC_UCODE_A_OFFS]);
    ...
    ctrl_streamer_o.d_sink_ctrl.addressgen_ctrl.base_addr   = reg_file_i.hwpe_params[MAC_REG_D_ADDR] +(flags_uloop_i.offs[MAC_UCODE_D_OFFS]); //2*(flags_uloop_i.offs[MAC_UCODE_A_OFFS]); 
    ...
    case(curr_state)
      ...
      FSM_START: begin
        ...
        if(flags_streamer_i.a_source_flags.ready_start &
          ...
          if(~ctrl_i.simple_mul&&(ctrl_i.shift==2))
